<?php
    function sslistening_structure($nilai){
        switch ($nilai) {
            case 0:
                $data = 20;
                break;
        ...
        <tbody>
            <?php foreach ($respon as $i => $respon) :?>
                ...
                <tr>
                    ...
                    <!-- <td style="padding: 10px"><center><?= listening($respon['nilai_listening'])?>(<?= $respon['nilai_listening']?>/50 )</center></td>
                    <td style="padding: 10px"><center><?= structure($respon['nilai_structure'])?>(<?= $respon['nilai_structure']?>/40)</center></td>
                    <td style="padding: 10px"><center><?= reading($respon['nilai_reading'])?>(<?= $respon['nilai_reading']?>/50)</center></td>
                    <td style="padding: 10px"><center><?= round($skor)?></center></td>
                    <td style="padding: 10px"><center><?= $skor?></center></td> -->
                </tr>
            <?php endforeach;?>
